	    					...
	    					<?php while(have_posts()):the_post(); ?>
								<div class="col-md-12">
									<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.html" class="img img-2"><?php the_post_thumbnail('post-thumbnail', ['class' => 'img img-2', 'title' => 'Feature image']);
 ?></a>
	            ...
	            <div class="sidebar-box ftco-animate">
	              ...
	              <div class="block-21 mb-4 d-flex">
	                <a class="blog-img mr-4" style="background-image: url(<?php echo get_template_directory_uri();?>/images/image_3.jpg);"></a>
	                <div class="text">
	                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control</a></h3>
	                  <div class="meta">
	                    <div><a href="#"><span class="icon-calendar"></span> June 28, 2019</a></div>
	            ...
	            <div class="sidebar-box ftco-animate">
	              ...
	              <ul class="tagcloud">
	                ...
	                <a href="#" class="tag-cloud-link">food</a>
							...
							<div class="sidebar-box subs-wrap img py-4" style="background-image: url(<?php echo get_template_directory_uri();?>/images/bg_1.jpg);">
